...
def arrange_complete_delivery_cmd_fields(product_id):
...
def test_product_command_complete_delivery_OK(config,product_id):
    ## Arrange
    product, carrier = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [
...
@pytest.mark.functional
def test_product_command_complete_delivery_missing_product_KO(config,product_id):
    ## Arrange
    _, carrier = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [
        CompleteProductDelivery(
                timestamp=utils.get_timestamp(),
                carrier=carrier,
...
@pytest.mark.functional
def test_product_command_complete_delivery_missing_carrier_KO(config,product_id):
    ## Arrange
    product, _ = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [ 
        CompleteProductDelivery(
                product=product,
                timestamp=utils.get_timestamp(),
...
@pytest.mark.functional
def test_product_command_complete_delivery_missing_timestamp_KO(config,product_id):
    ## Arrange
    product, carrier = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [
        CompleteProductDelivery(
...
@pytest.mark.functional
def test_product_command_complete_delivery_bad_timestamp_KO(config,product_id):
    ## Arrange
    product, carrier = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [
        CompleteProductDelivery(
...
@pytest.mark.functional
def test_product_command_complete_delivery_missing_attributes_KO(config,product_id):
    ## Arrange
    product, carrier = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [
        CompleteProductDelivery(
...
@pytest.mark.functional
def test_product_command_complete_delivery_bad_attributes_KO(config,product_id):
    ## Arrange
    product, carrier = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [
        CompleteProductDelivery(
...
@pytest.mark.functional
def test_product_command_complete_delivery_missing_api_key_OK(config,product_id):
    ## Arrange
    product, carrier = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [
        CompleteProductDelivery(
...
@pytest.mark.functional
def test_product_command_complete_delivery_wrong_api_key_OK(config,product_id):
    ## Arrange
    product, carrier = arrange_complete_delivery_cmd_fields(product_id=product_id)
    cmds = [
        CompleteProductDelivery(
