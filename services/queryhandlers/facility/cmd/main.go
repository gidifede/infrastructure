...
import (
	...
	"facility_queryhandler/internal/api"
	"facility_queryhandler/internal/handler"
...
func setupAPI() {
	...
	r.GET("/v1/network/setup", api.GetNetwork)
	r.GET("/v1/facility/:facility_id/short_stats", api.GetFacilityShortStats)
	r.GET("/v1/facility/:facility_id/parcels/details", api.GetFacilityParcelDetails)
	r.GET("/v1/facility/:facility_id/parcels/stats", api.GetFacilityParcelStats)
	r.GET("/v1/facility/:facility_id/sorting_machines/stats", api.GetFacilitySortingMachineStats)
	r.GET("/v1/facility/:facility_id/vehicles/stats", api.GetFacilityVehicleStats)
	r.GET("/v1/facility/:facility_id/vehicles/details", api.GetFacilityVehicleDetails)

	internal.GinLambda = ginadapter.New(r)
}
...
func setupDbConnection() {
	...
	internal.Repo = repository.NewMongoDB(*client.Database("test"))
}
