...
func TestParcelUnloadedManager_ManageEvent_OK_FacilityVehicleDocUpdated(t *testing.T) {
	...
	vehicleAlreadyInFacility2.Status = "unloading"
...
func TestParcelUnloadedManager_ManageEvent_KO_FacilityVehicleDocNotFound(t *testing.T) {
	facilityID := uuid.New().String()
	parcelID := uuid.New().String()
	vehicleID := uuid.New().String()
...
func TestParcelUnloadedManager_ManageEvent_KO_VehicleNotInFacility(t *testing.T) {
	facilityID := uuid.New().String()
	parcelID := uuid.New().String()
	vehicleID := uuid.New().String()
