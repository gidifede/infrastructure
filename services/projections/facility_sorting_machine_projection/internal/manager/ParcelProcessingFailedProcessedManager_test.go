...
func TestParcelProcessingFailedManager_ManageEvent_OK_SortingMachineUpdateItemProcessingRateDateFoundHourFound(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err != nil {
				t.Errorf("ParcelProcessingFailedManager.ManageEvent(). Cannot check test on doc id  %v", sortingMachineID)
			}
			if !reflect.DeepEqual(got, expSortingMachine) {
				t.Errorf("ParcelProcessingFailedManager.ManageEvent(). Read %v, want %v", got, expSortingMachine)
			}
		})
	}
}

func TestParcelProcessingFailedManager_ManageEvent_OK_SortingMachineUpdateItemProcessingRateDateFoundHourNotFound(t *testing.T) {
	sortingMachineID := uuid.New().String()
...
func TestParcelProcessingFailedManager_ManageEvent_OK_SortingMachineUpdateItemProcessingRateDateNotFound(t *testing.T) {
	sortingMachineID := uuid.New().String()
...
func TestParcelProcessingFailedManager_ManageEvent_KO_SortingMachineNotFound(t *testing.T) {
	sortingMachineID := uuid.New().String()
